    ...
    return (
        <div className="grid grid-cols-4 gap-x-[20px]">
            <div>
                ...
                <select id="generation" className="block w-full p-2.5 capitalize bg-[#253641] border border-gray-300 text-white text-sm rounded-lg focus:ring-[#3C5BAA] focus:border-[#3C5BAA]">
            ...
            <div>
                ...
                <select id="type" className="block w-full p-2.5 capitalize bg-[#253641] border border-gray-300 text-white text-sm rounded-lg focus:ring-[#3C5BAA] focus:border-[#3C5BAA]">
            ...
            <div>
                <label htmlFor="generation" className="block mb-2 text-white font-medium">Sort by</label>
                <select id="generation" className="block w-full p-2.5 capitalize bg-[#253641] border border-gray-300 text-white text-sm rounded-lg focus:ring-[#3C5BAA] focus:border-[#3C5BAA]">
